...
use Doctrine\DBAL\Driver\PDO\MySQL\Driver as MariaDBDriver;
use Override;

final class MariaDBContext extends AbstractDBContext implements Context
{
    ...
    #[Given('Connection to MariaDB database is established')]
